...
HD_PWD='D:/Study/USA_Graduate/WPI_Graduate_3/17_Fall_Courses/project_final/project_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_logic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_logic.tcl
