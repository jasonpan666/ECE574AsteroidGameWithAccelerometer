...
HD_PWD='D:/Study/USA_Graduate/WPI_Graduate_3/17_Fall_Courses/project_final/project_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_logic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_logic.tcl -notrace
